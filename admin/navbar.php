...
<nav id="sidebar" class='mx-lt-5' >
		...
		<div class="sidebar-list">
				...
				<a href="/hotel/mvc/checked_controller.php?Id=1&Command=showInfo" class="nav-item nav-site_settings"><span class='icon-field'><i class="fa fa-cogs"></i></span>Invoice</a>
			<?php endif; ?>
		</div>
